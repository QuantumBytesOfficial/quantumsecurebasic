...
$categories = [
    ...
    'RFID Readers' => [
     ...
     'AI Face' => [
        'AiFace-Orcus', 'AiFace-ERIS', 'AiFace-Arion', 'AiFace-Mars', 'AiFace-Mercury'
    ],
    // 'AI Face' => [
    //     'AiFace-Orcus', 'AiFace-ERIS', 'AiFace-Arion', 'AiFace-Mars', 'AiFace-Mercury', 'Aiface-Earth', 'AiFace-Uranus', 'AiFace-Neptune', 'AiFace-Pluto',
    //     'AiFace Venus', 'AiFace-Jupiter', 'Aiface Magnum', 'MU-AI-9 M/F',
...
$products = [
    ...
    22 => [
        ...
        'model' => 'AiFace-Mars',
        'brand' => 'eSSL Security',
        'image' => 'https://www.esslsecurity.com/storage/app/media/face/aiface-mars/mars.png',
        'pdf_catalogue' => 'https://www.esslsecurity.com/storage/app/media/face/aiface-mars/aiface-marscompressed_new.pdf',
        'video' => 'https://www.youtube.com/shorts/yqvdA7Q9eLk',
        'installation_guide_pdf' => 'https://www.esslsecurity.com/storage/app/media/face/Connection-Diagram/quick-start-guide-aiface-mars.pdf',
        'manual_pdf' => 'https://www.esslsecurity.com/storage/app/media/User-Manual/AiFace_Mars_usermanual.pdf',
        'original_price' => 24000,
        'discounted_price' => 18000,
        'discount' => 25,
    ...
    27 => [
        ...
        'model' => 'AiFace ERIS',
        'brand' => 'eSSL Security',
        'image' => 'https://www.esslsecurity.com/storage/app/media/face/aiface-mars/aifacemarsfp.jpg',
        'pdf_catalogue' => 'https://www.esslsecurity.com/storage/app/media/face/AIFACE_ERIS.pdf',
        'original_price' => 28000,
        'discounted_price' => 21000,
        'discount' => 25,
    ...
    35 => [
        ...
        'model' => 'AiFace-Orcus',
        'brand' => 'eSSL Security',
        'image' => 'https://www.esslsecurity.com/storage/app/media/face/Aiface-Orcus/Aiface_Orcus.png',
        'pdf_catalogue' => 'https://www.esslsecurity.com/storage/app/media/face/Aiface-Orcus/Aiface_Orcus.pdf',
        'manual_pdf' => 'https://www.esslsecurity.com/storage/app/media/face/AIface_Orcus_Manual.pdf',
        'original_price' => 25000,
        'discounted_price' => 12000,
        'discount' => 52,
        'description' => 'Advanced biometric attendance system with face and fingerprint recognition, anti-spoofing technology, and Wi-Fi connectivity',
        'specifications' => [
            ...
            'Authentication Speed' => 'Fingerprint: < 0.5 sec, Facial: < 0.35 sec',
            'Facial Authentication Distance' => '30cm to 200cm',
            'Communication' => 'TCP/IP, Wi-Fi, USB',
            'RFID Module' => 'Proximity Card @ 125 kHz (Standard), Mifare Card @ 13.56 MHz (Optional)',
            'Access Control Interface' => 'Electromagnetic Lock/Electric Lock, Door Sensor, Exit Button',
            'Power Supply' => 'DC 12V 1.5A',
            'Operating Temperature' => '-5°C to 45°C',
            'Operating Humidity' => '20% to 80% RH (Non-condensing)',
            'Dimensions' => '205.20 x 74.19 x 33.30 mm (L*W*H)',
            'FAR' => 'Facial: ≤ 0.01%, Fingerprint: ≤ 0.0001%',
            'FRR' => 'Facial: ≤ 0.02%, Fingerprint: ≤ 0.01%'
        ],
        'features' => [
            'Advanced Visible Light Facial Recognition',
            'Optical Fingerprint Verification', 
            'Multiple Authentication (Face/Fingerprint/Card/Password)',
        ...
        'keywords' => 'AiFace-Orcus, biometric attendance, face recognition, fingerprint scanner, anti-spoofing, Wi-Fi, access control, Linux, dual authentication'
    ],
    ...
    37 => [
        'id' => 37,
        'name' => 'eSSL AiFace-Arion',
        'category' => 'AI Face',
        'model' => 'AiFace-Arion',
        'brand' => 'eSSL Security',
        'image' => 'https://www.esslsecurity.com//storage/app/media/face/Ai-Face-Arion.jpg',
        'pdf_catalogue' => 'https://www.esslsecurity.com/storage/app/media/face/Aiface-Arion.pdf',
        'manual_pdf' => 'https://www.esslsecurity.com/storage/app/media/face/Aiface_Arion_Manual.pdf',
        'original_price' => 65000,
        'discounted_price' => 35000,
        'discount' => 46,
        'description' => 'Premium AI-powered facial recognition system with 5-inch display, WDR low light camera, and high-capacity multi-modal authentication',
        'specifications' => [
            'Display' => '5-Inch Touch Screen',
            ...
            'RAM' => '1GB',
            'ROM' => '8GB',
            'Fingerprint Template Capacity' => '6,000 (1:N)',
            'Face Template Capacity' => '6,000 (1:N)',
            'Card Capacity' => '10,000 (1:N)',
            'Transaction Capacity' => '200,000 (1:N)',
            'Biometric Verification Speed' => 'Fingerprint: < 0.3 sec, Facial Recognition: < 1 sec',
            'Facial Recognition Distance' => '1cm to 100cm',
            'Authentication Method' => 'Face / Fingerprint / Card / Password (Virtual Keypad)',
            'False Acceptance Rate (FAR)' => 'Facial: ≤ 0.01%, Fingerprint: ≤ 0.0001%',
            'False Rejection Rate (FRR)' => 'Facial: ≤ 0.02%, Fingerprint: ≤ 0.01%',
            'Card Type' => 'Proximity ID Card @ 125 kHz, Mifare IC Card @ 13.56 MHz (Optional), HID Prox/HID Iclass (Optional)',
            'QR Code Support' => 'QR code, PDF417, Data Matrix, MicroPDF417',
            'Communication' => 'TCP/IP, Wiegand (Input & Output), RS485, Wi-Fi',
            'Access Control Interface' => 'Electromagnetic Lock/Electric Lock, Door Sensor, Exit Button, Alarm Output',
            'Power Supply' => 'DC 12V 3A',
            'Operating Temperature' => '-10°C to 45°C',
            'Operating Humidity' => '10% to 90% RH (Non-condensing)',
            'Dimensions' => '91.93mm × 202.93mm × 21.5mm (L×W×H)',
            'Supported Software' => 'eTimetracklite Software, ebioServer'
        ],
        'features' => [
            '5-Inch HD Touch Display',
            'WDR Low Light Camera Technology',
            'Multi-Modal Authentication',
            'High Capacity Storage (6,000 faces)',
            'QR Code Support',
            'Wi-Fi Connectivity',
            'Virtual Keypad for Password Entry',
            'Anti-Spoofing Algorithm',
            'Wide Recognition Distance Range',
            'Access Control Integration',
            'Linux-Based Secure System'
        ],
        'keywords' => 'AiFace-Arion, 5 inch display, WDR low light camera, 6000 faces, QR code, virtual keypad, high capacity, Wi-Fi, access control'
    ],
